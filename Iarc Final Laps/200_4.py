...
def compute_waypoints(mav):
		...
		wayp12 = [x_init - x_offset -10, y_init2 + 7.5,height]
		wayp13 = [x_init - x_offset, y_init2 + 15,height]
		wayp21 = [x_init - 0, y_init2 + 15,height]
		wayp22 = [x_init +10, y_init2 + 7.5,height]
