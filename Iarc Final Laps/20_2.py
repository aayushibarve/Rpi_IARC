...
class FLIGHT_CONTROLLER:
	...
	def get_gps(self, data):
		...
		#print ("Origin:", self.gps.x, self.gps.y)
...
def compute_waypoints(mav):
		...
		wayp_11_2 = wpMissionCnt()
		wayp_12_2 = wpMissionCnt()
		wayp_13_2 = wpMissionCnt()
		wayp_21_2 = wpMissionCnt()
		wayp_22_2 = wpMissionCnt()
		wayp_23_2 = wpMissionCnt()
		wayp_11_3 = wpMissionCnt()
		wayp_12_3 = wpMissionCnt()
		wayp_13_3 = wpMissionCnt()
		wayp_21_3 = wpMissionCnt()
		wayp_22_3 = wpMissionCnt()
		wayp_23_3 = wpMissionCnt()
		wayp_11_4 = wpMissionCnt()
		wayp_12_4 = wpMissionCnt()
		wayp_13_4 = wpMissionCnt()
		wayp_21_4 = wpMissionCnt()
		wayp_22_4 = wpMissionCnt()
		wayp_23_4 = wpMissionCnt()
		wayp_11_5 = wpMissionCnt()
		wayp_12_5 = wpMissionCnt()
		wayp_13_5 = wpMissionCnt()
		wayp_21_5 = wpMissionCnt()
		wayp_22_5 = wpMissionCnt()
		wayp_23_5 = wpMissionCnt()
		wayp_11_6 = wpMissionCnt()
		wayp_12_6 = wpMissionCnt()
		wayp_13_6 = wpMissionCnt()
		wayp_21_6 = wpMissionCnt()
		wayp_22_6 = wpMissionCnt()
		wayp_23_6 = wpMissionCnt()
		wayp_11_7 = wpMissionCnt()
		wayp_12_7 = wpMissionCnt()
		wayp_13_7 = wpMissionCnt()
		wayp_21_7 = wpMissionCnt()
		wayp_22_7 = wpMissionCnt()
		wayp_23_7 = wpMissionCnt()
		wayp_11_8 = wpMissionCnt()
		wayp_12_8 = wpMissionCnt()
		wayp_13_8 = wpMissionCnt()
		wayp_21_8 = wpMissionCnt()
		wayp_22_8 = wpMissionCnt()
		wayp_23_8 = wpMissionCnt()
		...
		wayp11 = [x_init - x_offset, y_init2 + 0,height]
		print("Waypoint location:")
		print(wayp11)
		wayp12 = [x_init - x_offset - 5, y_init2 + 5,height]
		print(wayp12)
		wayp13 = [x_init - x_offset, y_init2 + 10,height]
		print(wayp13)
		wayp21 = [x_init - 0, y_init2 + 10,height]
		print(wayp21)
		wayp22 = [x_init +5, y_init2 + 5,height]
		print(wayp22)
		wayp23 = [x_init - 0,y_init2 + 0,height]
		print(wayp23)
		...
		print("Global waypoint coordinates")
		print(wp_g_11)
		if(wp_g_11[0] < 18 or wp_g_11[0] > 20):
			coordinates_range = False
			print(coordinates_range)
		wp_g_12 = xy2latlon(wayp12, origin)
		print(wp_g_12)
		if(wp_g_12[0] < 18 or wp_g_12[0] > 20):
			coordinates_range = False
		wp_g_13 = xy2latlon(wayp13, origin)
		print(wp_g_13)
		if(wp_g_13[0] < 18 or wp_g_13[0] > 20):
			coordinates_range = False
		wp_g_21 = xy2latlon(wayp21, origin)
		print(wp_g_21)
		if(wp_g_21[0] < 18 or wp_g_21[0] > 20):
			coordinates_range = False
		wp_g_22 = xy2latlon(wayp22, origin)
		print(wp_g_22)
		if(wp_g_22[0] < 18 or wp_g_22[0] > 20):
			coordinates_range = False
		wp_g_23 = xy2latlon(wayp23, origin)
		print(wp_g_23)
		if(wp_g_23[0] < 18 or wp_g_23[0] > 20):
			coordinates_range = False
		...
		wps.append(w)
		w = wayp_23.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		wps.append(w)
		#LAP2
		w = wayp_11_2.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_11[0], wp_g_11[1], wp_g_11[2])
		wps.append(w)
		w = wayp_12_2.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_12[0], wp_g_12[1], wp_g_12[2])
		wps.append(w)
		w = wayp_13_2.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_13[0], wp_g_13[1], wp_g_13[2])
		wps.append(w)
		w = wayp_21_2.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		wps.append(w)
		w = wayp_22_2.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_22[0], wp_g_22[1], wp_g_22[2])
		wps.append(w)
		w = wayp_23_2.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		wps.append(w)
		#LAP3
		w = wayp_11_3.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_11[0], wp_g_11[1], wp_g_11[2])
		wps.append(w)
		w = wayp_12_3.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_12[0], wp_g_12[1], wp_g_12[2])
		wps.append(w)
		w = wayp_13_3.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_13[0], wp_g_13[1], wp_g_13[2])
		wps.append(w)
		w = wayp_21_3.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		wps.append(w)
		w = wayp_22_3.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_22[0], wp_g_22[1], wp_g_22[2])
		wps.append(w)
		w = wayp_23_3.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		wps.append(w)
		# #LAP4
		w = wayp_11_4.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_11[0], wp_g_11[1], wp_g_11[2])
		wps.append(w)
		w = wayp_12_4.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_12[0], wp_g_12[1], wp_g_12[2])
		wps.append(w)
		w = wayp_13_4.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_13[0], wp_g_13[1], wp_g_13[2])
		wps.append(w)
		w = wayp_21_4.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		wps.append(w)
		w = wayp_22_4.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_22[0], wp_g_22[1], wp_g_22[2])
		wps.append(w)
		w = wayp_23_4.setWaypoints(3,21,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		wps.append(w)
		# #LAP5
		# w = wayp_11_5.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_11[0], wp_g_11[1], wp_g_11[2])
		# wps.append(w)
		# w = wayp_12_5.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_12[0], wp_g_12[1], wp_g_12[2])
		# wps.append(w)
		# w = wayp_13_5.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_13[0], wp_g_13[1], wp_g_13[2])
		# wps.append(w)
		# w = wayp_21_5.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		# wps.append(w)
		# w = wayp_22_5.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_22[0], wp_g_22[1], wp_g_22[2])
		# wps.append(w)
		# w = wayp_23_5.setWaypoints(3,21,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		# wps.append(w)
		# #LAP6
		# w = wayp_11_6.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_11[0], wp_g_11[1], wp_g_11[2])
		# wps.append(w)
		# w = wayp_12_6.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_12[0], wp_g_12[1], wp_g_12[2])
		# wps.append(w)
		# w = wayp_13_6.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_13[0], wp_g_13[1], wp_g_13[2])
		# wps.append(w)
		# w = wayp_21_6.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		# wps.append(w)
		# w = wayp_22_6.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_22[0], wp_g_22[1], wp_g_22[2])
		# wps.append(w)
		# w = wayp_23_6.setWaypoints(3,21,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		# wps.append(w)
		#LAP7
		# w = wayp_11_7.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_11[0], wp_g_11[1], wp_g_11[2])
		# wps.append(w)
		# w = wayp_12_7.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_12[0], wp_g_12[1], wp_g_12[2])
		# wps.append(w)
		# w = wayp_13_7.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_13[0], wp_g_13[1], wp_g_13[2])
		# wps.append(w)
		# w = wayp_21_7.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		# wps.append(w)
		# w = wayp_22_7.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_22[0], wp_g_22[1], wp_g_22[2])
		# wps.append(w)
		# w = wayp_23_7.setWaypoints(3,21,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		# wps.append(w)
		# #LAP8
		# w = wayp_11_8.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_11[0], wp_g_11[1], wp_g_11[2])
		# wps.append(w)
		# w = wayp_12_8.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_12[0], wp_g_12[1], wp_g_12[2])
		# wps.append(w)
		# w = wayp_13_8.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_13[0], wp_g_13[1], wp_g_13[2])
		# wps.append(w)
		# w = wayp_21_8.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		# wps.append(w)
		# w = wayp_22_8.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_22[0], wp_g_22[1], wp_g_22[2])
		# wps.append(w)
		# w = wayp_23_8.setWaypoints(3,21,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		# wps.append(w)\
...
if __name__ == '__main__':
	...
	if (True):		
		...
		time.sleep(2)
		#mav.set_Guided_mode()
		# mav.gotopose(x_init,y_init, 5)
		time.sleep(2)
		coord = compute_waypoints(mav)
		print("Coordinates within range:", coord)
		if(coord):
			mav.set_mode("AUTO")
			print("In AUTO MODE")
		else:
