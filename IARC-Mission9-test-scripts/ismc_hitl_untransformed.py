...
if __name__ == '__main__':
	...
	pickle_off = open("IARC-Mission9-test-scripts/traj/1D_t.txt", "rb")			#modify the first input in open() to be the location of the trajectory file, and default is in home
