...
def compute_waypoints(mav):
		...
		wayp11 = [x_init + 10, y_init + 0,5]
		wayp12 = [x_init + 15, y_init + 2.5,5]
		wayp13 = [x_init + 10, y_init + 5,5]
		wayp21 = [x_init + 0, y_init + 5,5]
		wayp22 = [x_init -5, y_init + 2.5,5]
		wayp23 = [x_init + 0,y_init + 0,5]
		...
		wps.append(w)
		w = wayp_23_2.setWaypoints(3,21,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		wps.append(w)
		print(wps)
		mav.wpPush(wps)
